...
class TabScrollSampleActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tab_scroll_sample)

        val lpTabLayout = findViewById<LPTabLayout>(R.id.lp_tab_layout_2)
        val vpTabLayout = findViewById<ViewPager>(R.id.vp_tab_layout_2)
        val adapter = TabSampleAdapter(this, supportFragmentManager, 4,lpTabLayout) {
            true
        }
